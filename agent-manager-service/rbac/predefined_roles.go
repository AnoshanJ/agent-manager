...
var PredefinedRolePermissions = map[string][]Permission{
	...
	RoleDeveloper: {
		...
		AgentKindRead,
		AgentCreate, AgentRead, AgentUpdate, AgentDelete, AgentBuild,
		AgentDeployNonProduction, AgentEnvNonProduction, AgentTokenManage, AgentAPIKeyManage,
		MonitorCreate, MonitorRead, MonitorUpdate, MonitorDelete, MonitorExecute,
		MonitorScoreRead,
	...
	RoleAILead: {
		...
		EvaluatorCreate, EvaluatorRead, EvaluatorUpdate, EvaluatorDelete,
		AgentKindRead,
		AgentRead, AgentBuild, AgentDeployNonProduction, AgentEnvNonProduction, AgentAPIKeyManage,
	...
	RolePlatformEngineer: {
		...
		AgentEnvNonProduction, AgentEnvProduction,
		MonitorRead, MonitorScoreRead,
		ObservabilityLogRead, ObservabilityBuildLogRead, ObservabilityMetricRead,
		CatalogRead,
		ProfileRead, ProfileUpdateAttributes,
	},
}
