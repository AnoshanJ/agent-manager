...
On a brand-new organization with no projects yet, you'll land on the **Projects**
view. That's the organization-wide screen listing every project across the org.
If a project already exists (for example a `default` one created earlier),
...
Once you're inside the project, click **Add Agent** and choose the agent type
you want to deploy:
