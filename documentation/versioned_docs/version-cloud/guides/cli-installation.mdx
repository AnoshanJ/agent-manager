...
:::info Prerequisites
You need an Agent Manager Cloud account before logging in. Sign up at [console.agent-manager.cloud.wso2.com](https://console.agent-manager.cloud.wso2.com/).
:::
...
`amctl` opens a browser window for sign-in. There's no separate Agent Manager username or password: sign in with your existing Google or GitHub account, the same way you do in the console.
